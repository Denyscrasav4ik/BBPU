...
Цей мод додає український переклад для гри Baldi's Basics Plus. Проєкт перебуває в активній розробці і **код може бути сирим**. На даний момент реалізовано 100% задуманого функціоналу.
